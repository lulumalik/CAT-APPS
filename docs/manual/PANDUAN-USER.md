# Panduan Peserta (User)

Manual book untuk **calon peserta / siswa** Pratistha Cendekia Prestasi — dari pertama kali mengunjungi website sampai aktif belajar di kelas.
...
1. Buka **https://pratisthaindonesia.com**
2. Di beranda, Anda dapat:
   - Membaca informasi program persiapan AKPOL
   - Mengunjungi **Tentang Kami** (profil lembaga, kontak, rekening resmi)
   - Mengunjungi **Selayang Pandang**
   - Mencoba **Tryout Gratis** (tanpa akun)
3. Untuk mendaftar kursus, klik **Login** → **Buat akun**, atau langsung **Daftar Peserta Kursus**

---

## 4. Langkah 2 — Buat Akun (Registrasi Awal)

1. Buka halaman **Daftar / Signup**
2. Isi form:
   - **Program / kategori** — pilih jenis kelas (Karantina, Reguler, Online, atau Ujian)
   - **Nama lengkap**
...
## 5. Langkah 3 — Alur Pendaftaran (Wizard)

Setelah daftar, buka menu **Alur Pendaftaran** (`/registration`).

Pendaftaran terdiri dari **4 tahap**:

### Tahap 1 — Administrasi (Anda isi sendiri)
...
- Pemeriksaan kesehatan dilakukan **offline**
- Pantau status verifikasi di wizard
...
- Baca pemberitahuan dari sistem (verifikasi email, status pendaftaran, laporan baru, dll.)
- Badge merah di menu menunjukkan jumlah belum dibaca

---

## 9. Tryout Gratis (Tanpa Akun)

1. Buka **Tryout Gratis** dari beranda
2. Pilih paket tryout yang **sedang berlangsung**
3. Isi data singkat (nama, gender, alamat, telepon, email)
4. Kerjakan soal dan lihat hasil langsung

Tryout gratis **tidak memerlukan** akun pendaftaran penuh.
...
*Selamat belajar dan sukses persiapan AKPOL!*
