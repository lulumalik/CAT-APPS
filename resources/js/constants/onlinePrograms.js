...
export const ONLINE_PROGRAMS = [
  {
    ...
    mode: 'Premium',
    cardBank: 'Pratistha Cendikia Prestasi',
    cardTheme: 'sunset',
    ...
    textColor: '#fff',
    boxShadow: '0 8px 32px rgba(255,215,0,0.45), 0 2px 8px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.4)',
    backgroundColor: [
      'radial-gradient(ellipse at 20% 18%, rgba(255,255,255,0.28) 0%, rgba(255,255,255,0.08) 25%, transparent 52%)',
      'radial-gradient(ellipse at 78% 88%, rgba(60,45,0,0.55) 0%, transparent 45%)',
      'linear-gradient(155deg, rgba(255,255,255,0.12) 0%, transparent 32%)',
      'linear-gradient(335deg, rgba(0,0,0,0.28) 0%, transparent 42%)',
      'linear-gradient(105deg,rgb(231, 179, 47) 0%,rgb(243, 184, 7) 30%,rgb(238, 185, 26) 50%,rgb(211, 157, 9) 70%,rgb(209, 161, 28) 100%)',
    ].join(', '),
  },
  {
    value: 'regular',
    ...
    boxShadow: '0 8px 32px rgba(0,255,0,0.45), 0 2px 8px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.25)',
    backgroundColor: [
      'radial-gradient(ellipse at 20% 18%, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0.06) 25%, transparent 52%)',
      'radial-gradient(ellipse at 78% 88%, rgba(0,40,0,0.55) 0%, transparent 45%)',
      'linear-gradient(155deg, rgba(255,255,255,0.1) 0%, transparent 32%)',
      'linear-gradient(335deg, rgba(0,0,0,0.3) 0%, transparent 42%)',
      'linear-gradient(105deg, #15803d 0%, #166534 30%, #14532d 50%, #0f5132 70%, #0a3d26 100%)',
    ].join(', '),
  },
  {
