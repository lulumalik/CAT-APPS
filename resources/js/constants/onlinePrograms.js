...
export const ONLINE_PROGRAMS = [
  {
    ...
    backgroundColor: [
      ...
      'radial-gradient(ellipse at 78% 88%, rgba(120,90,0,0.38) 0%, transparent 45%)',
      ...
      'linear-gradient(105deg,rgb(214, 182, 0) 0%,rgb(211, 180, 2) 30%, #ccac00 50%,rgb(199, 172, 0) 70%, #b8960a 100%)',
    ].join(', '),
  },
  {
    value: 'regular',
    ...
    backgroundColor: [
      ...
      'radial-gradient(ellipse at 78% 88%, rgba(0,80,0,0.38) 0%, transparent 45%)',
      ...
      'linear-gradient(105deg, #00FF00 0%, #00cc00 30%, #00b300 50%, #00e600 70%, #009900 100%)',
    ].join(', '),
  },
  {
